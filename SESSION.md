...
## ЧТО СДЕЛАНО ЗА СЕССИЮ (12 коммитов, сверху вниз)
...
1. Экспорт отчёта за цикл (текст/картинка для отправки).
2. Автосоздание подписок из повторяющихся выписок.
3. Полное экранирование esc() во всех местах вставки пользовательских строк (сейчас частично).
4. Firestore rules: убедиться, что доступ только владельцу (вне кода, в консоли Firebase).
5. Свайп-закрытие диалогов dConfirm/dPrompt (сейчас только шторка #sheet).
6. Проверить на живом Xiaomi 14: свайп шторки vs скролл списка (порог 90px, зона верхние 64px) — если мешает скроллу, поднять порог или сузить зону.
