...
## ЧТО СДЕЛАНО ЗА СЕССИЮ (16 коммитов, сверху вниз)
...
1. Firestore rules: убедиться, что доступ только владельцу (вне кода, в консоли Firebase).
2. Проверить на живом Xiaomi 14: свайп шторки vs скролл списка (порог 90px, зона верхние 64px); диалоги свайпятся вниз (80px).
3. Идея на будущее: «перевод жене/любимой» как регулярный платёж с учётом её ЗП-календаря (календарь любимой уже есть).
4. Идея: годовой отчёт (12 циклов одной лентой) для «как прошёл год».
